...
- Проектный опыт: Для каждого проекта должно быть указано: [Название проекта для резюме], [Период работы ММ.ГГГГ - ММ.ГГГГ], [Должность сотрудника на проекте], [Роль сотрудника], [Количество участников команды числом], [Наименование Заказчика + отрасль], [Описание проекта, включая выбранные функциональные блоки], [Функциональная область], [Программные продукты / стек].
